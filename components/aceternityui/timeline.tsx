      ...
      >
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            From humble beginnings to becoming Sydney's most trusted cleaning service, 
            our story is one of dedication, growth, and unwavering commitment to our values.
          </p>
        </motion.div>
