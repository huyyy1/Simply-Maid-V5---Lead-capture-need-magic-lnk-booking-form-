      ...
      <div className="container px-4 mx-auto">
        ...
        >
          <div className="text-center mb-16">
            ...
            >
              A Company with Purpose,<br />Built Around People
            </motion.h2>
          </div>
          ...
          <div className="prose prose-lg mx-auto dark:prose-invert">
            ...
            <Card className="p-8 my-12 bg-violet-50/50 dark:bg-gray-900/20 border-none">
              <p className="text-xl font-medium leading-relaxed !text-foreground">
                ...
                creating a seamless, trustworthy service that takes the hassle out of keeping 
                a home spotless."
              </p>
            </Card>

            <h3 className="text-2xl font-bold tracking-tight mt-16 mb-6">Our Story: From Vision to Reality</h3>
            <p className="text-muted-foreground leading-relaxed">
