...
import { Users, Star, Clock, Award, ChevronRight, Check, ArrowUpRight, TrendingUp, Target, Gift } from "lucide-react";
            ...
            <Card className="p-8 h-full hover:shadow-xl transition-shadow">
              <div className="h-full flex flex-col">
                <div className="flex items-start justify-between mb-8">
                  ...
                  <Badge variant="secondary" className="bg-primary/10 text-primary">Elite Program</Badge>
                </div>
