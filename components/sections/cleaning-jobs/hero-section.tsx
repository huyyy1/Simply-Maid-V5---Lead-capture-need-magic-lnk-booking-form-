          ...
          >
            ...
            <div className="space-y-6">
              <p className="text-xl text-white/90 leading-relaxed">
                Start this week – Flexible hours, great pay, and a supportive work environment. 
                Join over 500 trusted cleaners making a difference in homes across Australia.
              </p>
