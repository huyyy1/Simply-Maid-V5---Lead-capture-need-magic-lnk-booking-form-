              ...
              <div className="flex flex-col h-full">
                ...
                <div className="space-y-3 mt-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge variant="secondary" className="bg-white/20">Welcome</Badge>
                  </div>
                  <div className="flex items-center justify-between">
                    <span>Experienced</span>
                    <Badge variant="secondary" className="bg-white/20">Preferred</Badge>
                  </div>
                  <div className="flex items-center justify-between">
                    <span>Professional</span>
                    <Badge variant="secondary" className="bg-white/20">Leadership</Badge>
                  </div>
                </div>
              </div>
            </Card>
