...
export function getToken<
  ...
  K extends keyof typeof tokens[T]
>(category: T, token: K): typeof tokens[T][K] {
...
export function createTransition(
  ...
  const easingValue = tokens.animation.easings[category as keyof typeof tokens.animation.easings][
